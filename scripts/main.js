...
function createPostElement(postId, title, text, author, authorId, authorPic,time) {
  ...
  var html = '<div class="post post-' + postId + 'mdl-layout mdl-js-layout">'+
  '		<div class="transbg mdl-card mdl-shadow--6dp">'+
  '				<div class="innerdiv mdl-card mdl-shadow--6dp">'+
  '					<div class="mdl-card__title_post">'+
  '				<h5 class="mdl-card__title-text__name_post">'+title+'</h5>'+
  '						<h5 class="mdl-card__title-text__activity_post">'+text+'</h5>'+
  '			</div>'+
  '					<div class="mdl-card__time"><h6 class="mdl-card__title-text_post mdl-shadow--6dp">'+ time +'</h6></div>'+
  '				</div>'+
  '		</div>'+
  '</div>';
  ...
  var fetchPosts = function(postsRef, sectionElement) {
    postsRef.on('child_added', function(data) {
      ...
      containerElement.insertBefore(
        createPostElement(data.key, data.val().title, data.val().note, author, data.val().uid, data.val().authorPic, data.val().deepworkquantity),
